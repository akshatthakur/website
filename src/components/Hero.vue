  ...
  <background>
    <container>
      <text-container>
        ...
        <hr>
        <paragraph>Following graduation from the University of British Columbia with a <em>BSc.</em> in <em>Statistics and Computer Science</em>, I'm working at a Series-B funded Vancouver tech startup, where I swim in big data and competitive intelligence. If you need me for anything data-sciencey, or want to chat about jazz and rock 'n' rock music, writing, or anything else, chat with me <linked href="mailto:akshatvsthakur@gmail.com">here</linked>.</paragraph>
        ...
        <social-links>
          ...
          <social-link-text><linked href="/projects/CV.pdf" target="_blank"> Résumé </linked></social-link-text>
        </social-links>        
      </text-container>
    </container>
  </background>
